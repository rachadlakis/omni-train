...
- 4-bit quantization requires `peft.enabled=true` (cannot fine-tune 4-bit without adapters)
- 8-bit quantization is compatible with full fine-tuning (no PEFT required)
